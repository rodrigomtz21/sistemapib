  ...
  <table class="table-striped">
      <thead class="">
        <tr>
          ...
          <th colspan="{{$size}}" class="th-title">Vocaciones Regionales<th>
        </tr>
        <tr>
          
          <th colspan="{{$size}}" class="th-title"> Extra title<th>
        </tr>
        <tr>
          ...
          @foreach($data['consulta'] as $column)
              ...
              <tr>
                  @foreach($data['headers'] as $header)
                    ...
                    <td class="td-class" style="mso-number-format:'0.00';mso-number-format:'#,##0.00';">{{ $column[$header['name']] }}</td>
                  @endforeach
              </tr>
          @endforeach
      </tbody>
