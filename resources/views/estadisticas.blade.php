...
@if($data['valoracion_status'])
  <table class="table-striped">
      <thead class="thead-dark">
        ...
        <tr>
          <th colspan="{{count($data['headers'])}}" class="th-title">{{$data['valoracion']['title_valores']}}</th>
        </tr>
        <tr>
          ...
          @foreach($data['valoracion']['data'] as $column)
              ...
              <tr>
                  @foreach($data['headers'] as $header)
                    ...
                    <td class="" style="mso-number-format:'0.00';mso-number-format:'#,##0.00';">{{ $column[$header['header']] }}</td>
                  @endforeach
              </tr>
              <?php $contador++; ?>
          @endforeach
